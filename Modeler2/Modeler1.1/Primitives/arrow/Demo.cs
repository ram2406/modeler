...
namespace Modeler1._1.Primitives.arrow
{
    public class Arrowheads : Window
    {
        ...
        public Arrowheads()
        {
            ...
            aline1.BeginAnimation(Связь.ArrowAngleProperty, animaDouble1);
            ...
            aline1.BeginAnimation(Связь.ArrowLengthProperty, animaDouble2);

            // ArrowLine with animated point properties.
            Связь aline2 = new Связь();
            ...
            aline2.BeginAnimation(Связь.X1Property, animaDouble3);
            ...
            aline2.BeginAnimation(Связь.Y2Property, animaDouble4);
